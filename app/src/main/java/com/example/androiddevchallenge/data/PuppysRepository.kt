...
object PuppysRepository {
    val Edison = Puppy(
        id = 1,
        name = "Edison",
        age = "Adult",
        des = "Edison was found as a stray injured when he was attached by another dog. Edison" +
    ...
    val Precious = Puppy(
        ...
        name = "Precious",
        age = "Young",
        des = "Precious is a loving pup who just wants to be near her people. " +
    ...
    val Tink = Puppy(
        ...
        name = "Tink",
        age = "Young",
        des = "Hello, my name is Tink! I was rescued from the shelter in honor of a dog who suffered a horrible fate there. " +
    ...
    val Riley = Puppy(
        ...
        name = "Riley",
        age = "Young",
        des = "Riley was found as a stray by her foster, she is aprox. " +
    ...
    val Hula = Puppy(
        ...
        des = "Hula is a super smart amazing dog with so much love to give. " +
    ...
    val Buster = Puppy(
        ...
        name = "Buster",
        age = "Young",
        des = "Buster loves affection, hikes and treats! He's playful and loves hiking in the canyons.His favorite dinner dish is sloppy joes. " +
    ...
    val Lucas = Puppy(
        ...
        des = "Lucas was left in a balcony tied up and all because they had a baby and decided he would not be ok with their baby. " +
    ...
    val Harry = Puppy(
        ...
        des = "This little nugget had a rough start in life.. he came to us with dreadlocks!\n" +
    ...
    val Bronx = Puppy(
        ...
        des = "Everyone meet Bronx he is a sweet old man who came to us from a high kill shelter with a very low chance of being adopted due to his age. " +
    ...
    val Gunner = Puppy(
        ...
        des = "Love that Dog Hollywood is the Animal Rescue Initiative of The Daddio Collective; " +
    ...
    val Roxy = Puppy(
        ...
        name = "Roxy",
        age = "4 years old, Young",
        des = "Roxy was found tied to a post by a good samaritan. " +
